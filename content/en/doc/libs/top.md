...
**`typeof <value>`** - Get the type of data
- **Parameters**:
  - `value` (required): `Any` - Value to check type
- **Returns**: `String` - Type name
- **Example**: `typeof 123` returns "Integer"

if you are in CFM(command first mode),you should escape it via `lume -m` or `:` ahead of your command to get the right result.
