...
|----------|--------------|-------------------------------|
| [Fs](/en/libs/fs)     | 	File system operations    |	read, write, ls, dirs |
| [String](/en/libs/string)     | 	String operations	  | split, join, replace, lower, upper |
| [Regex](/en/libs/regex)    |	Regex operations	| match, replace, search |
| [List](/en/libs/list)     | 	List operations	  | first, last, map, filter |
| [Map](/en/libs/map)     | 	Map operations  	| keys, values, merge |
| [Math](/en/libs/math)     | 	Mathematical functions |	sin, cos, sqrt, rand |
| [Rand](/en/libs/rand)    |	Random number operations | int, float, choice, shuffle |
| [Time](/en/libs/time)     | 	Date and time operations |	now, parse, fmt, stamp |
| [From](/en/libs/from)     | 	Data parsing operations	  | json, toml, script, cmd |
| [Into](/en/libs/into)     | 	Data conversion operations	  | str, int, float, boolean, filesize, time, table, toml, json, csv |
| [Sys](/en/libs/sys)    |	Environment variable operations	| env, define, defined |
| [Console](/en/libs/console)    | 	Console operations	| color, table, prompt |
| [Ui](/en/libs/ui)    |	UI components	| pick, confirm, widget, joinx, joiny, join_flow |
| [Log](/en/libs/log)    |	Log operations	| debug, info, warn, error, trace |
| [Boolean](/en/libs/boolean)     | 	Boolean operations    |	and, or, not, xor |
| [Filesize](/en/libs/filesize)     | 	File size operations	  | to_bytes, to_kb, to_mb, format |
| [About](/en/libs/about)     | 	About information	  | version, build_info |
