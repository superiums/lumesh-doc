...
| *内置Lib库*   | 无                         | 内置大量实用函数              | 参见[Libs](/zh-cn/libs)    |
| *结构化管道*  | 无                         | 支持`into. \| where \| select `等便捷数据处理 |    |
...
6.  **条件执行**：从 `cmd1 && cmd2 || fallback` 可保持原样或改为 `cmd1 &: cmd2 ?: fallback`
...
1.  官方文档：[Lumesh 语法手册](/zh-cn/doc)
2.  基本语法：[Lumesh 语法和空格规则](/zh-cn/doc/symbo)
3.  详细对比：[Bash 泥泞人生路](/zh-cn/topics/bashlife)
